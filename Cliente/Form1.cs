    ...
    public partial class Form1 : Form
    {
        ...
        private void Atender_Peticiones_Servidor()
        {
            while (true) 
            {
                ...
                int codigo = Convert.ToInt32(trozos1[0]); //ERROR AQUI PARA INVITAR A UN JUGADOR
                ...
                switch (codigo)
                {
                    ...
                    case 14:
                        //Te invitan a jugar una partida: recibe 14/nombre del jugador que le invita/id partida
                    ...
                    case 15:
                        //Respondes a la invitacíon, recibimos 15/SI/idpartida o 15/NO/idpartida
                        if (mensaje == "SI")
                        {
                            MessageBox.Show("El jugador ha aceptado, ya podeis jugar juntos", username.Text);
                        }
                        else
                        {
                            MessageBox.Show("El jugador no quiere jugar contigo, lo sentimos");
                        }
                        break;
                }
            }
